...
var getCardNumberError = function getCardNumberError(cardNumber) {
  ...
  if (cardType && cardType.lengths) {
    var doesCardNumberMatchLength = cardType.lengths.includes(cardNumber.length);

    if (doesCardNumberMatchLength) {
      var isLuhnValid = validateLuhn(cardNumber);
...
var getExpiryDateError = function getExpiryDateError(expiryDate) {
...
var getCVCError = function getCVCError(expiryDate) {
