...
require('./utils/validator-2a3499e1.js');
...
function usePaymentCard() {
  ...
  var handleChangeCardNumber = React.useCallback(function () {
    ...
    return function (e) {
      ...
      cardNumberField.current.value = index.default.formatter.formatCardNumber(cardNumber); // Due to the card number formatting, the selection cursor will fall to the end of
  ...
  var handleChangeExpiryDate = React.useCallback(function () {
    ...
    return function (e) {
      ...
      var expiryDateError = index.default.validator.getExpiryDateError(expiryDate, {
        errorMessages: errorMessages
      });
  ...
  React.useLayoutEffect(function () {
    ...
    if (cvcField.current) {
      var cvcError = index.default.validator.getCVCError(cvcField.current.value, {
        errorMessages: errorMessages
      });
      setInputError('cvc', cvcError);
    }
